...
figma.on("run", ({ parameters }) => {
    ...
    let shapes = all.filter((n) => n.type === "ELLIPSE" || n.type === "POLYGON" || n.type === "RECTANGLE" || n.type === "STAR"), vectors = all.filter((n) => n.type === "VECTOR"), text = all.filter((n) => n.type === "TEXT"), parentFrame = all.filter((e) => "FRAME" === e.type && "PAGE" === e.parent.type), nonFrames = new Array();
